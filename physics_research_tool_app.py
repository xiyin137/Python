...
# --- CONFIGURATION ---
def get_script_dir():
    # Check if running as a compiled app (PyInstaller)
    if getattr(sys, 'frozen', False):
        application_path = os.path.dirname(sys.executable)
        # If inside a .app bundle (standard macOS app structure)
        if "Contents/MacOS" in application_path:
            # Go up 3 levels to get out of the .app bundle 
            # (e.g. from /Users/Me/Desktop/App.app/Contents/MacOS -> /Users/Me/Desktop)
            return os.path.abspath(os.path.join(application_path, "../../.."))
